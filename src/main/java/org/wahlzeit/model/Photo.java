...
public class Photo extends DataObject {
	...
	public void SetLocation(Location location) {
		...
		*/
		this.location = new Location(CartesianCoordinate.getCartesianCoordinate(location.getCoordinate().getX(), location.getCoordinate().getY(), location.getCoordinate().getZ()));
		incWriteCount();
		return;
	}
